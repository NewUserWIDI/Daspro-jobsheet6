...
public class Latihan3{
    public static void main(String[] args) {
        ...
        merk = Absen25.nextLine();
        System.out.println("Berapa ukuran sepatu anda : ");
        ukuran = Absen25.nextDouble();
        System.out.println("--------------------------------------------");
        ...
        if (merk.equalsIgnoreCase("Converse")) {
            ...
            if (ukuran >= 36 && ukuran<=40) {
                harga = 1000000;
                System.out.println("Kategori sepatu untuk woman/Wanita dengan harga Rp "+ harga);
            }
            else if (ukuran >= 41 && ukuran<=44) {
                harga = 180000;
                System.out.println("Kategori sepatu untuk man/Pri dengan harga Rp "+ harga);
            }else {
                System.out.println("Ukuran sepatu anda tidak tersedia!");
            }
